...
export type TagStatus = {
  ...
  last_restorable_seconds_behind?: number;
  last_restorable_version?: number;
  mutation_log_bytes_written?: number;
  mutation_stream_id?: string;
  range_bytes_written?: number;
  running_backup?: boolean;
  running_backup_is_restorable: boolean;
};
